<%-- 
    Document   : consultarFacturaRecurso
    Created on : 1/06/2016, 07:23:39 AM
    Author     : tuto2
--%>
...
<%
    ...
    if (session.getAttribute("usuario") == null) {
        ...
        if (!tipo.equals("empleado") || tipo.isEmpty()) {
            ...
            ArrayList<FacturaDTO> factura = fachada.consultarFacturaResRecurso(id_recurso);
%>

<jsp:include page="../plantillas/recepcionista/header.jsp"/>
<div class="card-panel  white z-depth-5" >
    <div class="row">
        <i class="material-icons left grey-text">search</i><h5>Facturas de reserva de recursos</h5>
        <li class="divider"></li>
    </div>
    <div class="row">
        <div class=" col s12">
    ...
    <form name="form1" action="consultarFacturasRecurso.jsp" method="POST">
        ...
        <div id="tablaAdmin">
            ...
            <div class="row">
                ...
                <div class="input-group col s6">
                    ...
                    <input type="text" name="id_recurso" id="id_recurso" placeholder="ID Reserva de recurso..." class="form-control">
                </div>
                <div class=" col s2">
